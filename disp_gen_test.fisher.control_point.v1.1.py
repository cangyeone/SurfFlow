...
def run_inversion_test(
    ...
    fig_dir="tfig/inversion_fisher_a",
    device=None,
    dataset_seed=2026,
    n_mean_init=100,
    n_invert=4,
    ...
    #)
    save_results_pickle(results, f"{fig_dir}/results_a.pkl")
    plot_inversion_results_4_with_dispersion(
        depth_km=depth_km,
        results=results,
        out_path=os.path.join(fig_dir, "inversion_vs_dispersion_compare_4samples_a.png"),
        max_depth_km=110.0,
        title_prefix=None,
    )
...
if __name__ == "__main__":
    ...
    run_inversion_test(
        ...
        fig_dir="tfig/inversion_fisher_b",
        device=None,
        dataset_seed=SEED,
        n_mean_init=100,
        n_invert=4,
