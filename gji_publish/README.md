...
This directory contains the manuscript-facing code and small artifacts for the
GJI submission on probabilistic surface-wave dispersion inversion with a
depth-controlled conditional rectified flow.
...
```bash
python gji_publish/scripts/train_di_fair.py --config gji_publish/configs/fair_di_strong_full.yaml
python gji_publish/scripts/train_di_fair.py --config gji_publish/configs/fair_di_weak_full.yaml
python gji_publish/scripts/eval_fair_di_comparison.py --help
python gji_publish/scripts/eval_fair_calibration.py --help
python gji_publish/scripts/eval_fair_noise_sensitivity.py --help
python gji_publish/scripts/eval_fair_missing_band.py --help
python gji_publish/scripts/eval_fair_sampling_sensitivity.py --help
python gji_publish/scripts/make_gji_review_figures.py
```

The full production run used matched strong/weak training budgets and is
documented in `results/fair_di_comparison/README.md` and the copied root
`README.md`.
